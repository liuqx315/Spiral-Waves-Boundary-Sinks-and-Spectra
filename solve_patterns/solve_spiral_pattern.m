...
file_names.out_name = '../data_files/Rossler_spiral_R125_c2_solved.mat';  % Out file 

file_names.solver_fcn = 'Rossler_2D_spiral_neumann';  % System to solve: F(U) = 0: can input Neumann or non-reflecting conditions here.
