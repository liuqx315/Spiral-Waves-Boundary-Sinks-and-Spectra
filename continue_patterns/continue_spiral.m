...
file_names.spiral = '../data_files/Rossler_spiral_R125_c2.mat'; % Initial data
file_names.out_name = '../data_files/Rossler_spiral_R125_solved_c2.mat';  % Out file 

file_names.problem = 'Rossler_2D_spiral_neumann';  % System to solve
...
contPar.final = 3;
contPar.ds = 0.1;                      % continuation step size: this is for a secant continuation, so does not directly compare to step size of parameter. should always be positive
contPar.initial_ds = 0.001;           % initial step: sign determines direction of continuation
contPar.Name = 'c';                % Continuation parameter
contPar.Free = 'omega';             % Free variable
contPar.numContSteps = 100;         % Maximum number of continuation steps
...
%save(file_names.out_name ,'U','par','numPar','cont_vec','free_vec','contPar');
